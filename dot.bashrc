...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+(\e[1;35mchr:$debian_chroot\e[m) }'
    PS1=$PS1'\[\e[0;32m\]\u@\h\[\e[m\] \[\e[1;34m\]\w\[\e[m\] \[\e[1;32m\]\$\[\e[m\] '
else
    PS1='${debian_chroot:+(chr:$debian_chroot) }'
    PS1=$PS1'\u@\h:\w\$ '
fi

# Make sure __git_ps1 exists
